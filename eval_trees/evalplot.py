...
#
        ...
        print("count displacements:", r.displacement_free)
...
#
    ...
    ax14.plot([displacements_ninety_percent, displacements_ninety_percent], [1, ymax], 'b--', label='90th percentile', linewidth=1)
